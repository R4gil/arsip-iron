    ...
    <div class="card-body px-0 py-0">
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background:#f8fafc;border-radius:12px 12px 0 0;">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('rak.exportExcel', request()->all())); ?>" class="btn btn-success btn-sm" style="background: linear-gradient(135deg, #10b981, #059669); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.25);">
                    <i class="fas fa-file-excel me-1"></i> Export Excel
                </a>
                <a href="<?php echo e(route('rak.exportPDF', request()->all())); ?>" class="btn btn-danger btn-sm" style="background: linear-gradient(135deg, #ef4444, #dc2626); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(239, 68, 68, 0.25);">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="white-space:nowrap;">
                            ...
                            <form action="<?php echo e(route('rak.destroy', $rack)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus rak ini?');"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="btn btn-sm" style="background: linear-gradient(135deg, #ef4444, #dc2626); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(239, 68, 68, 0.25); color: white;">Hapus</button></form>
                        </td>
                    </tr>
