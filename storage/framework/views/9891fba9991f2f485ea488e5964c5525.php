                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="jenis_arsip_id" class="form-select" required
                            ...
                            <?php $__currentLoopData = $jenis_arsips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e(old('jenis_arsip_id', optional($arsip)->jenis_arsip_id ?? '') == $item->id ? 'selected' : ''); ?>><?php echo e($item->nama_jenis); ?></option>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" class="form-select" required
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc; transition: border-color 0.2s;">
                            <option value="Aktif" <?php echo e(old('status', $arsip->status ?? '') == 'Aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="Inaktif" <?php echo e(old('status', $arsip->status ?? '') == 'Inaktif' ? 'selected' : ''); ?>>Inaktif</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="status_ketersediaan" class="form-select" required
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc; transition: border-color 0.2s;">
                            <option value="Tersedia" <?php echo e(old('status_ketersediaan', $arsip->status_ketersediaan ?? '') == 'Tersedia' ? 'selected' : ''); ?>>Tersedia</option>
                            <option value="Dipinjam" <?php echo e(old('status_ketersediaan', $arsip->status_ketersediaan ?? '') == 'Dipinjam' ? 'selected' : ''); ?>>Dipinjam</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" id="tanggal_arsip" name="tanggal_arsip" class="form-control"
                            value="<?php echo e(old('tanggal_arsip', isset($arsip->tanggal_arsip) ? date('Y-m-d', strtotime($arsip->tanggal_arsip)) : date('Y-m-d'))); ?>" required
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc; transition: border-color 0.2s;">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="masa_retensi" class="form-select" required
                            ...
                            <?php $__currentLoopData = ['3 Tahun', '5 Tahun', '10 Tahun']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($opsi); ?>" <?php echo e(old('masa_retensi', $arsip->masa_retensi ?? '') == $opsi ? 'selected' : ''); ?>><?php echo e($opsi); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nama_arsip" class="form-control"
                            value="<?php echo e(old('nama_arsip', $arsip->nama_arsip ?? '')); ?>"
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="lokasi_id" id="lokasi_id" class="form-select" required
                            ...
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($lok->id); ?>" <?php echo e(old('lokasi_id', $arsip->lokasi_id ?? '') == $lok->id ? 'selected' : ''); ?>><?php echo e($lok->ruangan); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <textarea name="perihal_surat" class="form-control" rows="3"
                            ...
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc; transition: border-color 0.2s;"><?php echo e(old('perihal_surat', $arsip->perihal_surat ?? '')); ?></textarea>
                    </div>
                    <div class="col-12">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px; background: #f8fafc;">
            <div class="card-body p-3">
                <div class="d-flex gap-2 justify-content-end">
                    <a href="<?php echo e(route('arsip.index')); ?>" class="btn btn-light px-4 py-2" style="border-radius: 8px; font-weight: 600; border: 1.5px solid #e2e8f0;">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        async function loadCabinets(locationId) {
            ...
            try {
                const url = new URL('<?php echo e(route('ajax.cabinets')); ?>', window.location.origin);
        ...
        async function loadRacks(cabinetId) {
            ...
            try {
                const url = new URL('<?php echo e(route('ajax.racks')); ?>', window.location.origin);
        ...
        <?php if(isset($arsip) && $arsip->lokasi_id): ?>
            const initialLocationId = <?php echo e($arsip->lokasi_id); ?>;
            const initialCabinetId = <?php echo e($arsip->cabinet_id ?? 'null'); ?>;
            const initialRackId = <?php echo e($arsip->rack_id ?? 'null'); ?>;
        ...
        async function searchClassifications(term) {
            const url = new URL('<?php echo e(route('ajax.klasifikasi')); ?>', window.location.origin);
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\iron-smart\resources\views/arsip/formulir.blade.php ENDPATH**/ ?>