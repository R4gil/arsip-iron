        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3" style="border-bottom: 2px solid #d4af37; padding-bottom: 10px;">
                    ...
                    <span class="badge fs-6 px-3 py-2" style="background: linear-gradient(135deg, #22c55e, #16a34a); color: #fff; font-weight: 600; border-radius: 8px;"><?php echo e($totalArsip); ?> tersedia</span>
                </div>

                <!-- Search -->
                <form method="GET" action="<?php echo e(route('peminjaman.create')); ?>" class="mb-3">
                    <div class="row g-2 align-items-end">
                        <div class="col-md-8">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control" placeholder="Cari arsip...">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background: #f8fafc; border-radius: 12px 12px 0 0;">
                    ...
                    <span style="color: #64748b; font-size: 0.8rem;">Total: <strong><?php echo e($totalArsip); ?></strong> arsip</span>
                </div>
                <div class="table-responsive">
                    <table class="table is-table mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $arsipTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arsip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-3 fw-bold"><?php echo e($arsip->nomor_surat ?? '—'); ?></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <?php if($arsip->file_arsip): ?>
                                    <?php $extension = strtolower(pathinfo($arsip->file_arsip, PATHINFO_EXTENSION)); ?>
                                    <button type="button" class="btn btn-sm is-btn-soft is-btn-soft-primary me-1" onclick="openDokumenModal('<?php echo e($arsip->file_arsip); ?>', '<?php echo e($arsip->nomor_surat); ?>', '<?php echo e($arsip->nama_arsip); ?>', '<?php echo e($extension); ?>')">Lihat</button>
                                    <?php endif; ?>
                                    <button type="button" class="btn btn-sm fw-bold" style="background: linear-gradient(135deg, #d4af37, #aa7c11); color: #1e293b; border: none; border-radius: 6px; padding: 0.4rem 1rem;" onclick="openPinjamModal(<?php echo e($arsip->id); ?>, '<?php echo e($arsip->nomor_surat); ?>', '<?php echo e($arsip->nama_arsip); ?>')">
                    ...
                    <div class="mt-3">
                        <?php echo e($arsipTersedia->withQueryString()->links('pagination::simple-bootstrap-4')); ?>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3" style="border-bottom: 2px solid #d4af37; padding-bottom: 10px;">
                    ...
                    <span class="badge fs-6 px-3 py-2" style="background: linear-gradient(135deg, #ef4444, #dc2626); color: #fff; font-weight: 600; border-radius: 8px;"><?php echo e($peminjamanAktif->count()); ?> aktif</span>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div>
                        <span style="color: #64748b; font-size: 0.8rem;">Total: <strong><?php echo e($totalPinjam); ?></strong> peminjaman</span>
                    </div>
                </div>
                    ...
                    <table class="table is-table mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $peminjamanAktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pinjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-3 fw-bold"><?php echo e($pinjam->archive->nomor_surat ?? '—'); ?></td>
                                <td><?php echo e($pinjam->archive->nama_arsip ?? '—'); ?></td>
                    ...
                    <div class="mt-3">
                        <?php echo e($peminjamanAktif->withQueryString()->links('pagination::simple-bootstrap-4')); ?>
                ...
                <form action="<?php echo e(route('peminjaman.store')); ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_peminjam" class="form-control"
                            value="<?php echo e(auth()->user()->nama_pengguna ?? auth()->user()->name); ?>" required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="divisi_peminjam" class="form-control" value="<?php echo e(auth()->user()->unit_kerja); ?>"
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold" style="color: #334155; font-size: 0.85rem;">Tanggal Pinjam <span class="text-danger">*</span></label>
                        <input type="date" name="tanggal_keluar" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required
                            style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc;">
                    </div>
                    <div class="mb-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iron-smart\resources\views/peminjaman/tambah.blade.php ENDPATH**/ ?>