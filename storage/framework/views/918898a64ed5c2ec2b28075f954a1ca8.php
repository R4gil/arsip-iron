...
<div class="alert border-0 shadow-sm mb-4 d-flex align-items-center" style="background: linear-gradient(135deg, #fff7ed, #ffedd5); border-left: 4px solid #f59e0b !important; border-radius: 12px;">
    ...
    <div>
        <?php if(($retensiNotifBaru ?? 0) > 0): ?>
            <strong>⚠️ <?php echo e($retensiNotifBaru); ?> arsip baru</strong> memasuki masa retensi!
        <?php endif; ?>
        Terdapat <strong><?php echo e($arsipMasukRetensi); ?></strong> arsip yang sudah memasuki masa retensi.
        <a href="<?php echo e(route('retensi.index')); ?>" class="fw-bold ms-1">Lihat daftar retensi →</a>
    </div>
</div>
<?php endif; ?>
...
<div class="alert border-0 shadow-sm mb-4 d-flex align-items-center" style="background: linear-gradient(135deg, #fef2f2, #fee2e2); border-left: 4px solid #dc2626 !important; border-radius: 12px;">
    ...
    <div>
        Ada <strong><?php echo e($retensiNotifBaru); ?></strong> notifikasi retensi arsip baru yang belum Anda lihat.
        <a href="<?php echo e(route('retensi.index')); ?>" class="fw-bold ms-1">Klik untuk melihat →</a>
    </div>
</div>
<?php endif; ?>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-xl-4 col-md-6">
        <div style="background-color: <?php echo e($stat['bg']); ?>; border: none; box-shadow: 0 4px 15px rgba(0,0,0,0.1); border-radius: 14px; padding: 1.25rem;">
            ...
            <div style="color: #fff; font-size: 0.8rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em;"><?php echo e($stat['label']); ?></div>
            <div style="color: #fff; font-weight: 700; font-size: 1.75rem; line-height: 1; margin-top: 0.25rem;"><?php echo e($stat['value']); ?></div>
        </div>
    </div>
...
<div class="row g-3 mb-4">
    <div class="col-lg-8">
        <div class="is-card is-chart-card h-100">
            <div class="card-header py-3 px-4">Tren Arsip Masuk <?php echo e(date('Y')); ?></div>
        ...
        <div class="is-card h-100">
            ...
            <div class="is-card-body">
                <ul class="list-unstyled mb-0">
                    <?php $__empty_1 = true; $__currentLoopData = $jenisData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="d-flex justify-content-between align-items-center py-2 border-bottom">
                            <span class="text-secondary"><?php echo e($item->label ?? 'Tidak ada data'); ?></span>
                            <span class="badge rounded-pill" style="background:#fef3c7;color:#92400e;"><?php echo e($item->total); ?></span>
                        </li>
        ...
        <div class="table-responsive">
            <table class="table is-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4 fw-semibold"><?php echo e($arsip->nama_arsip ?? 'Tanpa judul'); ?></td>
                        <td class="text-muted"><?php echo e($arsip->created_at ? \Carbon\Carbon::parse($arsip->created_at)->format('d M Y') : '—'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script>
    ...
    const monthData = [<?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($arsipPerBulan->where('bulan', $m)->first()->total ?? 0); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>];
    ...
    new Chart(document.getElementById('donutChart'), {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($statusData->pluck('label')); ?>,
            datasets: [{ data: <?php echo json_encode($statusData->pluck('total')); ?>, backgroundColor: ['#d4af37', '#f59e0b', '#ef4444'], borderWidth: 0 }]
        },
    ...
    new Chart(document.getElementById('barChart'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($lokasiData->pluck('label')); ?>,
            datasets: [{ label: 'Jumlah', data: <?php echo json_encode($lokasiData->pluck('total')); ?>, backgroundColor: 'rgba(212,175,55,0.75)', borderRadius: 8 }]
        },
        options: { maintainAspectRatio: false, plugins: { legend: { display: false } }, scales: { y: { beginAtZero: true, grid: { color: '#f1f5f9' } }, x: { grid: { display: false } } } }
    });
</script>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iron-smart\resources\views/dashboard/index.blade.php ENDPATH**/ ?>