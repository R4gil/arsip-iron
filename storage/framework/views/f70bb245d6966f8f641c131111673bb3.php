...
<div class="row">
    <div class="col-lg-12">
        <section class="card">
            ...
            <div class="card-body">
                <form method="GET" action="<?php echo e(route('pengguna.index')); ?>" class="mb-4">
                    <div class="row">
                        <div class="col-sm-6">
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control" placeholder="Cari nama, username, atau email...">
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <a class="btn btn-default" href="<?php echo e(route('pengguna.index')); ?>">Reset</a>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="card-body px-0 py-0">
                        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background: #f8fafc; border-radius: 12px 12px 0 0;">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select class="form-select form-select-sm" style="width: auto; min-width: 70px; border-radius: 6px; border: 1.5px solid #e2e8f0; font-size: 0.8rem; background-color: #fff;" onchange="window.location.href='<?php echo e(route('pengguna.index')); ?>?per_page='+this.value+'&search=<?php echo e(request('search')); ?>&role=<?php echo e(request('role')); ?>'">
                        ...
                        <div class="table-responsive">
                            <table class="table is-table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($user->profile_photo): ?>
                                                <img src="<?php echo e(route('profile.photo', $user->profile_photo)); ?>" alt="Profile" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%; border: 2px solid #d4af37;">
                                            <?php else: ?>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="is-badge <?php echo e($roleBadge); ?>"><?php echo e(ucfirst($user->role)); ?></span>
                                        </td>
                                    ...
                                    <form method="POST" action="<?php echo e(route('pengguna.destroy', $user->id)); ?>" class="d-inline-block" onsubmit="return confirm('Yakin ingin menghapus?');">
