...
<?php $__env->startSection('title','Lemari Arsip'); ?>
<?php $__env->startSection('content'); ?>
<?php echo $__env->make('partials.page-header',['title'=>'Lemari Arsip','subtitle'=>'Kelola lemari berdasarkan lokasi ruangan.','action'=>route('lemari.create'),'actionLabel'=>'Tambah Lemari'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="card border-0 shadow-sm" style="border-radius:12px;">
    <div class="card-body px-0 py-0">
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background:#f8fafc;border-radius:12px 12px 0 0;">
            <div class="d-flex align-items-center gap-2">
                ...
                <select class="form-select form-select-sm" style="width:auto;min-width:70px;border-radius:6px;border:1.5px solid #e2e8f0;font-size:0.8rem;background-color:#fff;" onchange="window.location.href='<?php echo e(route('lemari.index')); ?>?per_page='+this.value+'&lokasi_id=<?php echo e(request('lokasi_id')); ?>'">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('lemari.exportExcel', request()->all())); ?>" class="btn btn-success btn-sm" style="background: linear-gradient(135deg, #10b981, #059669); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(16, 185, 129, 0.25);">
                    <i class="fas fa-file-excel me-1"></i> Export Excel
                </a>
                <a href="<?php echo e(route('lemari.exportPDF', request()->all())); ?>" class="btn btn-danger btn-sm" style="background: linear-gradient(135deg, #ef4444, #dc2626); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(239, 68, 68, 0.25);">
        ...
        <div class="table-responsive">
            <table class="table is-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-3 text-muted"><?php echo e($cabinets->firstItem()+$loop->index); ?></td>
                        <td><?php echo e($cabinet->location?->ruangan??'—'); ?></td>
                        <td class="fw-bold"><?php echo e($cabinet->lemari_nama); ?></td>
                        <td><a href="<?php echo e(route('rak.index',['lemari_id'=>$cabinet->lemari_id,'lokasi_id'=>$cabinet->ruangarsip_id])); ?>" class="text-decoration-none fw-semibold"><?php echo e($cabinet->racks_count); ?> rak</a></td>
                        <td class="text-center" style="white-space:nowrap;">
                            <a href="<?php echo e(route('rak.create',['lokasi_id'=>$cabinet->ruangarsip_id,'lemari_id'=>$cabinet->lemari_id])); ?>" class="btn btn-sm me-1" style="background:linear-gradient(135deg,#d4af37,#aa7c11);color:#1d2127;border:none;font-weight:700;border-radius:8px;box-shadow:0 2px 6px rgba(212,175,55,0.25);">+ Rak</a>
                            <a href="<?php echo e(route('lemari.edit', $cabinet)); ?>" class="btn btn-sm me-1" style="background:#fffbeb;color:#b45309;border:1.5px solid #fcd34d;font-weight:600;border-radius:8px;">Edit</a>
                            <form action="<?php echo e(route('lemari.destroy', $cabinet)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Hapus lemari ini?');"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?><button class="btn btn-sm" style="background: linear-gradient(135deg, #ef4444, #dc2626); border: none; font-weight: 600; border-radius: 8px; box-shadow: 0 2px 6px rgba(239, 68, 68, 0.25); color: white;">Hapus</button></form>
                        </td>
                    </tr>
    ...
    <div class="card-body border-top d-flex justify-content-between align-items-center" style="background:#f8fafc;border-radius:0 0 12px 12px;">
        ...
        <?php echo e($cabinets->withQueryString()->links('pagination::simple-bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\iron-smart\resources\views/lemari/index.blade.php ENDPATH**/ ?>