...
<form method="GET" action="<?php echo e(route('arsip.exportExcel')); ?>" id="exportExcelForm" style="display:none;"><input type="hidden" name="ids" id="exportExcelIds"></form>
            ...
            <div class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <select name="status_retensi" class="form-select form-select-sm">
                        ...
                        <option value="Belum Masuk Masa Retensi" <?php echo e(request('status_retensi') == 'Belum Masuk Masa Retensi' ? 'selected' : ''); ?>>Belum Masuk Masa Retensi</option>
