						...
						<div class="row align-items-center pt-3">
							...
							<div class="col-md-8 col-lg-6 col-xl-5 custom-header-bar py-4 pe-5 appear-animation p-relative z-index-2" data-appear-animation="maskRight" data-appear-animation-delay="1200" data-appear-animation-duration="750">
								<div class="appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1500">
									...
									<p class="position-relative text-color-light text-center font-weight-normal opacity-7 mb-1">* Aproved by over 9K+ buyers since 2014</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container pb-5" style="min-height: 1000px;">
						...
						<div class="row text-center mb-5 pb-lg-3">
							...
							<div class="col-md-6 col-lg-4 text-center divider-left-border">
								<div class="appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="750" data-appear-animation-duration="750">
									<h3 class="font-weight-bold text-color-dark text-14 line-height-1 negative-ls-2 mb-2">9K+</h3>
						...
						<div class="intro row align-items-center justify-content-center justify-content-md-start pb-5 pb-md-0">
							<div class="col-3 pe-0 ps-3 z-index-2">
								<img src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/intro2.jpg" class="img-fluid border border-width-10 border-color-light box-shadow-5 rounded d-none d-md-block appear-animation" alt="Screenshot 2" data-appear-animation="fadeInUp" data-appear-animation-delay="600">
							...
							<div class="col-10 col-md-9 ps-0 pe-5 pb-5 pb-md-0 mb-5 mb-md-0 p-relative">
								...
								<div class="intro3 z-index-3 position-absolute appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="800" style="top: 20%; right: 4%;">
									<img src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/intro3.jpg" class="img-fluid border border-width-10 border-color-light box-shadow-6 rounded" alt="Screenshot 3">
					...
					<div class="container">
						<div class="row align-items-center justify-content-between">
							<div class="col-lg-4 pe-lg-4 mb-5 mb-md-0">
								...
								<p class="pe-lg-5">A complete suite of tools designed to make life easier with a top quality admin templates.</p>
							</div>
							...
							<div class="col-lg-11">	
								<div class="row justify-content-center">
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600" data-appear-animation-duration="750">
										...
										<p class="pe-5 custom-text-color-2">Choose Porto Admin and make your site at high performance. We know your project must the fast as possible.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800" data-appear-animation-duration="750">
										...
										<p class="pe-5 custom-text-color-2">Porto has a very solid development base that has been improved since 2014 by our best developers.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000" data-appear-animation-duration="750">
										...
										<p class="pe-5 custom-text-color-2">The designs of all pages and all demos included in Porto Admin were created by usability experts and modern designs standards.</p>
									</div>
									<div class="col-10 col-sm-6 col-lg-4 image-box appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300" data-appear-animation-duration="750">
										...
										<p class="pe-5 custom-text-color-2">4.85 average rating based on 2.5k+ review proves that Porto is loved by our customers.</p>
									</div>
					...
					<div class="container text-center py-5 mb-5">
						...
						<div class="row align-items-center pb-md-5 mb-md-5">
							...
							<div class="col-5 d-none d-md-block">
								<div class="text-end me-3 me-lg-5 ml-auto mb-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600" data-appear-animation-duration="750" style="max-width: 244px;" data-plugin-options="{'accY': -100}">
					...
					<div class="container-fluid" id="demos">
						<div class="row justify-content-center portfolio-list sort-destination overflow-visible" data-sort-id="portfolio">
							...
							<div class="col-8 col-sm-6 col-md-4 col-lg-3 col-xl-1-5 isotope-item">
								<div class="portfolio-item hover-effect-1 text-center pb-2 mb-3false">
						...
						<div class="row align-items-center pt-2 pb-3 mt-4 mb-5">
							...
							<div class="col-lg-5 text-center px-lg-0">
								...
								<div class="d-flex align-items-center justify-content-center">
									...
									<p class="mb-0 line-height-5 ls-0 text-color-light font-weight-500 text-start appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1300" data-appear-animation-duration="750">Menus, Nav Icons, Search Icons, Alerts,<br>Account Items, Search and much more...</p>
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section section-funnel position-relative z-index-3 border-0 pt-0 m-0">
					<div class="container pb-5">
						<h2 class="fotn-weight-extra-bold text-center mt-0 mb-1">
							<b class="text-color-dark text-13 d-block line-height-1 font-weight-extra-bold appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="250" data-appear-animation-duration="750">9K+</b>
				...
				<section id="support" class="section section-angled bg-light border-0 m-0 position-relative z-index-3 pt-0">
					<div class="container pb-5 mb-5">
						<div class="row align-items-center mb-5">
							...
							<div class="col-lg-4 offset-lg-2 p-relative">
								<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="500">
								...
								<img alt="Porto Support" src="img/lazy.png" data-plugin-lazyload data-plugin-options="{'threshold': 500, 'effect':'fadeIn'}" data-original="img/landing/support_login.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 ms-5 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="200" style="width: 590px; max-width: none;">
				...
				<section class="section section-dark section-angled border-0 pb-0 m-0" style="background-size: 100%; background-position: top;" data-plugin-lazyload data-plugin-options="{'threshold': 500}" data-original="img/landing/build_bg.jpg">
					...
					<div class="container text-center py-5 mt-5 mb-4">
						...
						<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900" data-appear-animation-duration="750">
							<h4 class="font-weight-light text-color-light text-4 col-lg-6 px-0 offset-lg-3 fw-400 mb-5 opacity-8">Porto Admin has been available on ThemeForest since 2014 and is one of the top sellers with more than 9K+ sales.</h4>
						</div>
			...
			<footer id="footer" class="bg-color-dark-scale-5 border border-end-0 border-start-0 border-bottom-0 border-color-light-3 mt-0">
				...
				<div class="copyright bg-color-dark-scale-4 py-4">
					<div class="container text-center py-2">
						<p class="mb-0 text-2 ls-0">Copyright 2014 - 2023 Porto - All Rights Reserved</p>
					</div>
				</div>
			</footer>
		</div>
