...
<div class="card border-0 shadow-sm" style="border-radius: 12px;">
    <div class="card-body px-0 py-0">
        <div class="d-flex justify-content-between align-items-center px-3 py-2 border-bottom" style="background: #f8fafc; border-radius: 12px 12px 0 0;">
            <div class="d-flex align-items-center gap-2">
                ...
                <select class="form-select form-select-sm" style="width: auto; min-width: 70px; border-radius: 6px; border: 1.5px solid #e2e8f0; font-size: 0.8rem; background-color: #fff;" onchange="window.location.href='{{ route('klasifikasi.index') }}?per_page='+this.value">
        ...
        <div class="table-responsive">
            <table class="table is-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-3 text-muted">{{ $classifications->firstItem() + $key }}</td>
                        <td class="fw-bold">{{ $classification->kode }}</td>
    ...
    <div class="card-body border-top d-flex justify-content-between align-items-center" style="background: #f8fafc; border-radius: 0 0 12px 12px;">
        ...
        {{ $classifications->withQueryString()->links('pagination::simple-bootstrap-4') }}
    </div>
    @endif
</div>
