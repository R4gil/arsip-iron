...
@section('content')
@include('partials.page-header', ['title' => 'Ubah Lokasi', 'subtitle' => 'Perbarui data ruangan penyimpanan.'])
...
<div class="card border-0 shadow-sm" style="border-radius: 12px;">
    <div class="card-body p-4">
        <h6 class="fw-bold mb-4" style="color: #1e293b; font-size: 0.9rem; letter-spacing: 0.03em; text-transform: uppercase; border-bottom: 2px solid #d4af37; padding-bottom: 10px;">
            <i class="fas fa-edit me-2" style="color: #d4af37;"></i>Form Edit Lokasi
        </h6>
        <form action="{{ route('lokasi.update', $location) }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="ruangan" class="form-control" value="{{ old('ruangan', $location->ruangan) }}" required
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="keterangan" class="form-control" value="{{ old('keterangan', $location->keterangan) }}"
                        style="border-radius: 8px; border: 1.5px solid #e2e8f0; padding: 0.6rem 0.75rem; font-size: 0.9rem; background-color: #f8fafc;">
                </div>
            </div>
